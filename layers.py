...
class ParallelLinearLayer(SplittableModule):
    ...
    def __init__(self, n_models, in_features, out_features, weight_gain=0.25, weight_init_mode='normal',
        ...
        self.weight_factor = (weight_gain/np.sqrt(in_features)).astype(np.float32)
    ...
    def forward(self, x):
        # print('weight type is ',self.weight.dtype)
        # print('weight_factor is ',self.weight_factor.dtype)
        # print('bias.dtype ',self.bias.dtype)
        # print('bias_factor.dtype is ',self.bias_factor.dtype)
