...
def test_model(model, data, n_models, test_idxs):
    ...
    for i in range(n_models):
        ...
        q95_errors.append(errors_sorted[int(0.95 * test_idxs.shape[-1])].squeeze().tolist()[0])
        #q99_errors.append(errors_sorted[int(0.99 * test_idxs.shape[-1])].item())
        q99_errors.append(errors_sorted[int(0.99 * test_idxs.shape[-1])].squeeze().tolist()[0])
